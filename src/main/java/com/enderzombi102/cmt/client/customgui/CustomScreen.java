...
//			Screen.LOGGER.error("Couldn't read the screen file for \"" + id + "\"", e);
//		} catch ( MissingKeyException e ) {
//			// grave user error
//			Screen.LOGGER.error("Couldn't find required \"" + e.key + "\" key in root object for screen \" " + id + "\", aborting", e);
//		} catch (SyntaxError e) {
//			// user syntax error
//			Screen.LOGGER.error( e.getMessage() );
//			Screen.LOGGER.error( e.getLineMessage() );
//		}
